const PlantConfig = {
    TIER_NORMAL: 'normal',
    TIER_ABERRANT: 'aberrant',
    TIER_OLD_ONE: 'old_one',

    CATEGORY_FLESH: 'flesh',
    CATEGORY_STELLAR: 'stellar',
    CATEGORY_DEEP: 'deep',
    ...
    _data: {
        cthulhu_seedling: {
            ...
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: true,
            canGrowInRain: true,
            canGrowInFog: true,
            requiresAncientFertilizer: true,
            canBeRipened: true,
            hasAwareness: true,
            awarenessChance: 0.01,
            awarenessType: 'whisper'
        },
        deep_onion: {
            id: 'deep_onion',
            name: '深渊洋葱',
            ...
            requiredFieldType: 'normal',
            canGrowAtNight: true,
            canGrowAtDay: true,
            canGrowInRain: true,
            canGrowInFog: true,
            requiresAncientFertilizer: false,
            canBeRipened: true,
            hasAwareness: false
        },
        nightshade_berry: {
        ...
        shoggoth_sprout: {
            ...
            canBeRipened: false,
            hasAwareness: true,
            awarenessChance: 0.05,
            awarenessType: 'shapeshift',
            harvestCurses: ['临时失明', '肢体麻木', '声音过敏']
        },
        deep_one_seed: {
            id: 'deep_one_seed',
            name: '深潜者之种',
            ...
            canBeRipened: false,
            hasAwareness: true,
            awarenessChance: 0.03,
            awarenessType: 'call',
            harvestCurses: ['幻听', '深海恐惧症', '鱼鳞状皮疹']
        },
        cthulhu_eye_flower: {
            ...
            canBeRipened: false,
            hasAwareness: true,
            awarenessChance: 0.08,
            awarenessType: 'stare',
            harvestCurses: ['永久凝视', '噩梦缠身', '理智流失']
        },
        mi_go_mycelium: {
            id: 'mi_go_mycelium',
            name: '米·戈菌丝',
            ...
            canBeRipened: false,
            hasAwareness: true,
            awarenessChance: 0.04,
            awarenessType: 'mind_control',
            harvestCurses: ['思维入侵', '记忆混乱', '语言障碍']
        },
        azathoth_core: {
            id: 'azathoth_core',
            name: '阿撒托斯核心',
        ...
        nyarlathotep_tendril: {
            ...
            canBeRipened: false,
            hasAwareness: true,
            awarenessChance: 0.06,
            awarenessType: 'deception',
            harvestCurses: ['幻觉欺骗', '人格分裂', '身份迷失']
        },
        yog_sothoth_gate: {
            id: 'yog_sothoth_gate',
            name: '犹格·索托斯之门',
            ...
            canBeRipened: false,
            hasAwareness: true,
            awarenessChance: 0.07,
            awarenessType: 'portal',
            harvestCurses: ['时空穿越', '记忆重叠', '存在分裂']
        },
        flesh_wheat: {
            id: 'flesh_wheat',
            name: '肉芽麦田',
            ...
            sellPrice: 120,
            buyPrice: 50,
            description: '收割时会发出诡异的呻吟，产出血肉素材',
            sanityLossOnHarvest: 5,
            pollutionGainOnHarvest: 3,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: true,
            canGrowInRain: true,
        ...
        pulsating_root: {
            ...
            sellPrice: 150,
            buyPrice: 65,
            description: '如同心跳般有规律地搏动的诡异根茎',
            sanityLossOnHarvest: 6,
            pollutionGainOnHarvest: 4,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: false,
            canGrowInRain: true,
            ...
            canBeRipened: true,
            hasAwareness: true,
            awarenessChance: 0.015,
            awarenessType: 'pulse',
            harvestMaterial: 'pulsating_organ'
        },
        flesh_tuber: {
            id: 'flesh_tuber',
            name: '血肉块茎',
            ...
            sellPrice: 180,
            buyPrice: 80,
            description: '表面覆盖着黏液的怪异块茎，触感温热',
            sanityLossOnHarvest: 8,
            pollutionGainOnHarvest: 5,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: false,
            canGrowInRain: true,
            ...
            canBeRipened: true,
            hasAwareness: true,
            awarenessChance: 0.02,
            awarenessType: 'absorb',
            harvestMaterial: 'flesh_tuber_core'
        },
        hallucination_mushroom: {
            id: 'hallucination_mushroom',
            name: '幻视蘑菇',
            tier: 'aberrant',
            category: 'stellar',
            stages: ['孢子', '菌柄', '幻视蘑菇'],
            ...
            sellPrice: 100,
            buyPrice: 45,
            description: '夜晚会发出微弱的荧光，孢子有致幻效果',
            sanityLossOnHarvest: 4,
            pollutionGainOnHarvest: 2,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: false,
            canGrowInRain: true,
            ...
            hasAwareness: true,
            awarenessChance: 0.01,
            awarenessType: 'hallucination',
            glowAtNight: true,
            highYield: true
        },
        deep_spore_flower: {
            id: 'deep_spore_flower',
            name: '深空孢子花',
            tier: 'aberrant',
            category: 'stellar',
            stages: ['星尘', '花茎', '深空孢子花'],
            ...
            canBeRipened: true,
            hasAwareness: true,
            awarenessChance: 0.012,
            awarenessType: 'stargaze',
            glowAtNight: true,
            highYield: true
        },
        star_weed: {
            ...
            sellPrice: 80,
            buyPrice: 35,
            description: '生命力极强的杂草，夜晚会发出星星点点的光芒',
            sanityLossOnHarvest: 3,
            pollutionGainOnHarvest: 2,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: true,
        ...
        astral_flower: {
            ...
            sellPrice: 160,
            buyPrice: 70,
            description: '据说可以连接星界的神秘花朵',
            sanityLossOnHarvest: 7,
            pollutionGainOnHarvest: 4,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: false,
            ...
            hasAwareness: true,
            awarenessChance: 0.015,
            awarenessType: 'astral_contact',
            glowAtNight: true,
            highYield: true
        },
        tidal_aquatic_grass: {
            id: 'tidal_aquatic_grass',
            name: '潮声水草',
            tier: 'aberrant',
            category: 'deep',
            stages: ['潮芽', '水茎', '潮声水草'],
            ...
            sellPrice: 110,
            buyPrice: 50,
            description: '雨天/雾天加速生长，自带水属性污染',
            sanityLossOnHarvest: 4,
            pollutionGainOnHarvest: 5,
            requiredFieldType: 'water',
            canGrowAtNight: true,
            canGrowAtDay: true,
            canGrowInRain: true,
            canGrowInFog: true,
        ...
        tentacle_vine: {
            ...
            sellPrice: 130,
            buyPrice: 55,
            description: '如同深海生物触须般的藤蔓，雨天更加活跃',
            sanityLossOnHarvest: 6,
            pollutionGainOnHarvest: 6,
            requiredFieldType: 'water',
            canGrowAtNight: true,
        ...
        shoggoth_moss: {
            ...
            sellPrice: 280,
            buyPrice: 110,
            description: '来自原始深渊的不定形生物组织，仅低理智可种植',
            isTaboo: true,
            requiredSanityLevel: 'madness',
            sanityLossOnHarvest: 12,
            pollutionGainOnHarvest: 8,
        ...
        black_wool_fruit: {
            ...
            sellPrice: 320,
            buyPrice: 130,
            description: '果实覆盖着黑色羊毛状物质，收获伴随随机诅咒',
            isTaboo: true,
            requiredSanityLevel: 'madness',
            sanityLossOnHarvest: 14,
            pollutionGainOnHarvest: 9,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: false,
            ...
            hasAwareness: true,
            awarenessChance: 0.03,
            awarenessType: 'consume',
            harvestCurses: ['毛发疯长', '皮肤石化', '食欲异常']
        },
        whisper_grass: {
            id: 'whisper_grass',
            name: '低语草',
            ...
            sellPrice: 250,
            buyPrice: 100,
            description: '风吹过时会发出诡异的低语声',
            isTaboo: true,
            requiredSanityLevel: 'madness',
            sanityLossOnHarvest: 10,
            pollutionGainOnHarvest: 7,
            requiredFieldType: 'corrupted',
            canGrowAtNight: true,
            canGrowAtDay: false,
            canGrowInRain: true,
        ...
        sea_scale_coral: {
            ...
            sellPrice: 300,
            buyPrice: 120,
            description: '深海珊瑚的变种，表面覆盖着鳞片',
            isTaboo: true,
            requiredSanityLevel: 'madness',
            sanityLossOnHarvest: 11,
            pollutionGainOnHarvest: 8,
            requiredFieldType: 'water',
            canGrowAtNight: true,
            canGrowAtDay: false,
            ...
            awarenessChance: 0.03,
            awarenessType: 'song',
            harvestCurses: ['鱼鳞状皮疹', '深海恐惧症', '呼吸窘迫']
        },
        misty_tomato: {
            id: 'misty_tomato',
            name: '迷雾番茄',
